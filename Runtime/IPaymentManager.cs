...
namespace GameFrameX.Payment.Runtime
{
    ...
    public interface IPaymentManager
    {
        ...
        [UnityEngine.Scripting.Preserve]
        void QueryPurchases(string productType);
        ...
        [UnityEngine.Scripting.Preserve]
        void BuyInApp(string productId, string orderId, string offerToken = "", string customData = "");
        ...
        /// <param name="customData">自定义数据</param>
        [UnityEngine.Scripting.Preserve]
        void BuySubs(string productId, string orderId, string offerToken = "", string customData = "");
        ...
        /// <param name="customData">自定义数据</param>
        [UnityEngine.Scripting.Preserve]
        void Buy(string productId, string productType, string orderId, string offerToken = "", string customData = "");
    }
}